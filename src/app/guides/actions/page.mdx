...
If a form is used to navigate, the data will be a [FormData](https://developer.mozilla.org/en-US/docs/Web/API/FormData) instance. When the action is completed successfully, the router will start navigation to the target url.
...
<div className="not-prose flex flex-col items-start">
	<Button href="/guides/callbacks" variant="text" arrow="right">
		<>Tell me more about the navigation callbacks</>
	</Button>
</div>
