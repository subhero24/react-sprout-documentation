...
These callbacks can be added as properties to the [Router](/components/router) element to be called for all router navigations.
...
They can also be used as properties to [Link](/components/link) and [Form](/components/form) elements to be invoked only with navigations from these components.
