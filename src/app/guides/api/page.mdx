...
As there is no server side rendering the route components will be ignored. An empty route component can be used.
...
On the client, not specifyign an action or loader implementation will use the server api of the corresponding server route.
