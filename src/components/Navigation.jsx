...
export const navigation = [
	...
	},
	{
		...
		links: [
			...
			{ title: 'Sticky navigations', href: '/guides/sticky-navigations' },
			{ title: 'Reload navigations', href: '/guides/reload-navigations' },
			...
			{ title: 'Canceling navigations', href: '/guides/canceling-navigations' },
		],
	},
	...
	},
	{
		title: 'Hooks',
		links: [
			{ title: 'useLink', href: '/hooks/use-link' },
			{ title: 'useForm', href: '/hooks/use-form' },
			{ title: 'useNavigate', href: '/hooks/use-navigate' },
			{ title: 'useNavigations', href: '/hooks/use-navigations' },
			{ title: 'useAbort', href: '/hooks/use-abort' },
			{ title: 'useSplat', href: '/hooks/use-splat' },
			{ title: 'useParams', href: '/hooks/use-params' },
			{ title: 'useHistory', href: '/hooks/use-history' },
			{ title: 'useLocation', href: '/hooks/use-location' },
